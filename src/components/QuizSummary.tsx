                    ...
                    {expandedQuestion === answer.questionIndex && (
                      ...
                      >
                        <div>
                          ...
                          >
                            <span className="font-bold">{answer.userAnswer}.</span> {answer.options.find((opt) => opt.label === answer.userAnswer)?.text || answer.userAnswer}
                          </p>
                        </div>
                        {!answer.isCorrect && (
                          <div>
                            ...
                            >
                              <span className="font-bold">{answer.correctAnswer}.</span> {answer.options.find((opt) => opt.label === answer.correctAnswer)?.text || answer.correctAnswer}
                            </p>
                          </div>
                        )}
                      </div>
